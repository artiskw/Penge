<?php $current_form_id='popup_bg_single_page_service_top'; ?>
<div id="<?= $current_form_id; ?>" class="fr-widget fr-container fid-621c809e48f442adcb1a2b36 fr_popup_bg "
 ...
             action="<?php echo get_site_url() . '/wp-json/' . APG_FORM_ENDPOINT. APG_FORM_API_NAME;?>"
              ...
              target="_blank">
            <input type="hidden" name="form_id" value="question_single_service_top">
            ...
            <div id="text_67"
                ...
                <div class="fr-text">
                    <h2><?php pll_e("form_title_single_service_top"); ?></h2>
                </div>
            </div>
