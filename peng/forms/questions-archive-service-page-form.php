<?php $current_form_id='popup_bg_service_page_service'; ?>
<div id="<?= $current_form_id; ?>" class="fr-widget fr-container fid-621c809e48f442adcb1a2b36 fr_popup_bg ">
    <div class="popup fr-widget fr-container fid-621c7fa048f442adcb1a2a39 fr_popup ">
        <form class="fr-widget fr-form fr-wf fid-621c803448f442adcb1a2af4 fr_form_with_name_and_email_input
              ...
              target="_blank">
            <input type="hidden" name="form_id" value="question_course_home_page">
            ...
            <div id="text_67"
                ...
                <div class="fr-text">
                    <h2><?php pll_e("form_title_archive_service"); ?></h2>
                </div>
            </div>
            ...
            <div class="fr-widget fr-container fr_container_67">
                <div class="custom-select">
                    <select name="custom_post_id">
                        <?php apgut_outputCustomPostsAsOptions('services'); ?>
                    </select>
                </div>
            </div>
