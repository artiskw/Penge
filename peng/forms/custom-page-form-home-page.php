<?php $current_form_id='form_home_page'; ?>
<div id="<?= $current_form_id; ?>" class="fr-widget fr-container fid-621c809e48f442adcb1a2b36 fr_popup_bg "
    ...
    <div id="popup" class="fr-widget fr-container fid-621c7fa048f442adcb1a2a39 fr_popup "
        ...
        <form class="fr-widget fr-form fr-wf fid-621c803448f442adcb1a2af4 fr_form_with_name_and_email_input
              ...
              target="_blank">
            <input type="hidden" name="form_id" value="<?= $current_form_id ;?>">
            ...
            <div id="text_67"
                ...
                <div class="fr-text">
                    <h2><?php pll_e("form_title_page_acedemy"); ?></h2>
                </div>
            </div>
            <div id="styled_form_grid" class="fr-widget fr-grid fid-621c803548f442adcb1a2afc fr_styled_form_grid "
            ...
            <div class="fr-widget fr-grid fr_styled_form_grid "
                 data-id="621c803548f442adcb1a2afc" style="margin-top:0.6rem;">
                <div class="fr-widget fr-input fr-wf fid-621c803548f442adcb1a2b13 fr_input_5 "
                     data-id="621c803548f442adcb1a2b13">
                    <input type="text" class="fr_input_5" placeholder="<?php pll_e("apg_form_phone"); ?>" name="phone"
                           required>
                </div>
            </div>
            <div id="container_67" class="fr-widget fr-container fid-621c96e248f442adcb1a2b52 fr_container_67 "
                ...
                <div id="input_19" class="fr-widget fr-input fr-wf fid-621c929048f442adcb1a2b48 fr_input_19 "
                    ...
                    <textarea class="fr_input_19" placeholder="<?php pll_e("apg_form_placeholder_business_description"); ?>"
        ...
        <script>
            ...
            }).call(document.getElementsByClassName('fr_popup')[0], window, document, (window.Froont && window.Froont.jQuery || window.jQuery));
        </script>
    </div>
    <script>
        (function (window, document, $) {
        ...
        }).call(document.getElementsByClassName('fr_popup_bg')[0], window, document, (window.Froont && window.Froont.jQuery || window.jQuery));
    </script>
</div>