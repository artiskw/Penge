...
<div id="footer_3" class="fr-widget fr-container fid-61f935ece45c30b6a846ec2e    fr_footer_3">
    <div id="container_56" class="fr-widget fr-container fid-620bb01bf776be1568b50ee5 fr_container_56 "
        ...
        <div id="uneven_grid" class="fr-widget   fr-grid fid-61f938c6f68726ca7deff979 fr_uneven_grid "
            ...
            <div id="container_49" class="fr-widget fr-container fid-61fdab9e434844b07b0d2d6b fr_container_49 ">
                <div id="text_401"
                     class="fr-widget fr-text fr-wf fr-richtext fid-61fd108b69b8ef7679879ce8 fr_bright_heading fr_text_401 "
                     data-id="61fd108b69b8ef7679879ce8">
                    <div class="fr-text">
                        <h4><?php pll_e("apg_company_details_title"); ?></h4>
                    </div>
                </div>
                <div id="text_419"
                     class="fr-widget fr-text fr-wf fr-richtext fid-61fda90e434844b07b0d2d3b fr-widget fr-text fr-wf fr-richtext fid-623c730342d1ffe4242e722b    fr_text_532 fr_text_bright">
                    <div class="fr-text">
                        <p style="white-space: pre-line;"><?php pll_e("apg_company_details"); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="text_block_9"
         class="fr-widget fr-text fr-wf fr-richtext fid-620bb07df776be1568b50ef7 fr_text_bright_center fr_text_block_9 "
         data-id="620bb07df776be1568b50ef7">
        <div class="fr-text">
    ...
    <a id="text_261"
       class="fr-widget fr-text fr-wf fr-richtext fid-61f938def68726ca7deffa1f fr_text_261 fr_contact_link fr-link "
       data-id="61f938def68726ca7deffa1f" href="<?php echo $footer['apg_privacy_policy']; ?>"
       data-fr-popup-align="center">
        <div class="fr-text">
            <p style="text-align: center"><?php pll_e("apg_privacy_policy"); ?></p>
        </div>
    </a>
</div>
</div>
