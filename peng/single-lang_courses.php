<?php get_header(); ?>
<?php include 'forms/single-pages-forms/language/lang-form-top.php'; ?>
<?php include 'forms/single-pages-forms/language/lang-form-bottom-register.php'; ?>
<?php include 'forms/single-pages-forms/language/lang-form-bottom-apply.php'; ?>
                        ...
                        <script>
                            (function (window, document, $) {
                                ...
                                $(this).click(function (event) {
                                    ...
                                    $('#popup_bg_single_page_lang_top').css('display', 'flex')
                                })
    ...
    <div id="text_heading__2_columns__anchors"
        ...
        <div id="c14_container" class="fr-widget fr-container fid-621c7ea966db03310568ac16 fr_c14_container "
          ...
          <?php if( get_field('apg_language_time_plan') ): ?>
             <div id="container_89" class="fr-widget fr-container fid-623bfccf82d82fabad44fe8f fr_container_89 "
                ...
                <div id="text_64"
                    ...
                    <div class="fr-text">
                        <?php echo the_field('apg_language_time_plan'); ?>
                    </div>
                </div>
                </div>
            <?php endif; ?>
                      ...
                      data-fr-animation-delay="0.5s">
                       ...
                       <script>
                           (function (window, document, $) {
                               ...
                               $(this).click(function (event) {
                                   event.preventDefault()
                                   $('#popup_bg_single_page_lange_bottom_register').css('display', 'flex')
                               })
                      ...
                      data-fr-animation-delay="0.5s">
                       ...
                       <script>
                           (function (window, document, $) {
                               ...
                               $(this).click(function (event) {
                                   event.preventDefault()
                                   $('#popup_bg_single_page_lange_bottom_apply').css('display', 'flex')
                               })
...
<?php $show_hide_lecture_language_information = get_field('apg_language_lecture_information_hide_or_show'); ?>
<?php $language_lecturer = get_field('apg_language_lecturer_information'); ?>
<?php if ($show_hide_lecture_language_information === true) : ?>
    <div id="container_96" class="fr-widget fr-container fid-623c3d8d10beb0a255f1b304    fr_container_96 "
        ...
        <div id="lecturer" class="fr-widget fr-container fid-621c7ea966db03310568ac9d    fr_lecturer "
            ...
            <div id="text_85"
                ...
                <div class="fr-text">
                    <h2><?php echo $language_lecturer['apg_title']; ?></h2>
                </div>
            </div>
            <div id="grid_17" class="fr-widget   fr-grid fid-621c7ea966db03310568aca3    fr_grid_17 "
                ...
                <div id="container_50"
                    ...
                    <div id="image_2" class="fr-widget fr-img fid-621c7ea966db03310568acbf    fr_image_2 "
                        ...
                        <img src="<?php echo $language_lecturer['apg_lecture_image']; ?>"/>
                    </div>
                    <div id="text_block_6" class="fr-widget fr-text fr-wf fr-richtext fid-621c7ea966db03310568acd5    fr_bright_heading fr_text_block_6
                        ...
                        <div class="fr-text">
                            <h2><?php echo $language_lecturer['apg_lecture_name']; ?></h2>
                        </div>
                    </div>
                </div>
                <div id="container_51"
                    ...
                    " data-id="621c7ea966db03310568acd1">
                        <div class="fr-text">
                            <p><?php echo $language_lecturer['apg_title_script']; ?></p>
                        </div>
                    </div>
                    <a id="linkedin_square_icon"
                       ...
                       href="<?php echo $language_lecturer['apg_affiliate_link']; ?>"
                    ...
                    <div id="grid_18" class="fr-widget   fr-grid fid-621c7ea966db03310568acd7 fr_grid_18 ">
                        <?php
                        if (is_array(($language_lecturer['apg_lecture_experience']))) :
                            $item_count = count($language_lecturer['apg_lecture_experience']);
                                ...
                                <div id="html"
                                    ...
                                    <ul>
                                        <?php for ($key = 0; $key < $column_count; $key++) :
                                            $item = $language_lecturer['apg_lecture_experience'][$start_with + $key];
                                            ?>
                                            <li>
                    ...
                    <div class="fr-widget   fr-grid fid-621c7ea966db03310568acdb    fr_grid_19 ">
                        <?php
                        if (is_array(($language_lecturer['apg_achievements']))) :
                            $item_count = count($language_lecturer['apg_achievements']);
                            $item_count_mod = $item_count % 2;
                            ...
                            for ($i = 0; $i < 2; $i++) :
                                ...
                                <div class="fr-widget fr-html fr-wf fid-621c7ea966db03310568ad1a    fr_html_3 ">
                                    ...
                                    <ul>
                                        <?php for ($key = 0; $key < $column_count; $key++) :
                                            $item = $language_lecturer['apg_achievements'][$start_with + $key];
                                            ?>
