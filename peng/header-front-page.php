...
<head>
    ...
    <meta name="DC.language" scheme="ISO639-1" content="<?=pll_current_language(); ?>">    <meta property="og:site_name" content="Pange">
...
<body>
    <div class="b-content hide-footer">
        <div id="language_nav" class="fr-widget fr-container fr_language_nav">
        ...
        <div id="nav_with_logo" class="fr-widget fr-container fr_nav_with_logo_2">
            <div id="navigation_dark_with_logo_2" class="fr-widget fr-navigation fr-navigation-active fr_navigation_dark_with_logo_2">
                <a id="logo_2" class="fr-widget fr-img fr_logo_2 fr-link" href="<?php echo get_site_url(); ?>" data-fr-popup-align="center"> <?php $custom_logo_id = get_theme_mod('custom_logo'); ?>
                ...
                <div id="mobile_toggle_2"
                     class="fr-widget fr-navigation-toggle fr_mobile_toggle_2">
                ...
                <div id="items_2" class="fr-widget fr-container fid-61f93592e45c30b6a846ebce fr_items_2" data-id="61f93592e45c30b6a846ebce">
                    <?php
